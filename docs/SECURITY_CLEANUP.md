...
### 1. Zeabur API Token
**Token**: `sk-gunsc3tyolpxb7beylvkwkhexcxqd`
**洩漏位置**:
- `.mcp.json` (已追蹤到 Git)
...
3. [ ] 撤銷 token `sk-gunsc3tyolpxb7beylvkwkhexcxqd`
...
# 清理敏感資料
bfg --replace-text <(echo 'sk-gunsc3tyolpxb7beylvkwkhexcxqd==>***REMOVED***') --no-blob-protection
...
# 清理特定字串
echo 'sk-gunsc3tyolpxb7beylvkwkhexcxqd==>***REMOVED***' > /tmp/replacements.txt
